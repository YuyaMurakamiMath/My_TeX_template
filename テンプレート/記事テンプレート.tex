...
\zcref{thm:1,thm:2,thm:3,lem:1,eq:2,sec:environment,subsec:thm,subsec:ref,subsec:program}から...

equation*などの*付き数式環境は使えないので注意.
crefで複数のラベルを参照する時は「,」の後にスペースを空けないように注意.
例えば\verb*|\zcref{thm:1, thm:2}|としてしまうと\verb|thm:1|と\verb*| thm:2|が参照されることになってしまう. 
